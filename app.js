...
mongoose
  .connect(
    ...
    "mongodb+srv://shrutikachavan:shrutikachavan123@cluster0.r3gpwit.mongodb.net/test"
  )
  ...
  uploadSingle(req, res, (err) => {
    if (err) {
      ...
      userModel
        ...
        .then((data) => {
          let mailOptions = {
            from: "chavanshrutika1999@gmail.com",
            to: email,
...
// "mongodb+srv://shrutikachavan:shrutika@cluster0.r3gpwit.mongodb.net/test"